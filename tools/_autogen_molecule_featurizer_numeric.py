...
from rdkit.Chem.Descriptors import (MinEStateIndex,BCUT2D_MRLOW,NumSaturatedHeterocycles,fr_piperzine,HallKierAlpha,fr_COO2,PEOE_VSA13,BalabanJ,NumHAcceptors,fr_Ar_OH,fr_ether,fr_phenol,NumAliphaticHeterocycles,SlogP_VSA6,fr_azide,PEOE_VSA9,PEOE_VSA3,VSA_EState8,fr_NH0,fr_tetrazole,fr_C_S,MinAbsPartialCharge,fr_benzodiazepine,Chi3v,fr_nitro_arom_nonortho,Chi4n,NumSaturatedRings,NumSaturatedCarbocycles,fr_Al_OH,EState_VSA7,SMR_VSA5,MaxEStateIndex,NHOHCount,EState_VSA8,SlogP_VSA12,NumRadicalElectrons,fr_ketone_Topliss,fr_SH,fr_benzene,HeavyAtomCount,fr_ketone,NumHDonors,Chi1,EState_VSA1,fr_NH1,EState_VSA11,EState_VSA10,fr_para_hydroxylation,MaxPartialCharge,Kappa3,VSA_EState4,Chi3n,Chi0v,fr_epoxide,SlogP_VSA8,fr_allylic_oxid,PEOE_VSA10,fr_furan,fr_oxime,fr_pyridine,fr_isothiocyan,fr_nitrile,fr_thiocyan,Chi2v,MinAbsEStateIndex,FractionCSP3,MolWt,PEOE_VSA2,FpDensityMorgan2,fr_phos_ester,fr_Al_COO,fr_imidazole,fr_aryl_methyl,fr_sulfone,SlogP_VSA10,NumAromaticCarbocycles,NumAromaticHeterocycles,fr_nitro,fr_term_acetylene,MaxAbsPartialCharge,fr_Nhpyrrole,EState_VSA4,NumAliphaticRings,Ipc,fr_halogen,LabuteASA,BCUT2D_LOGPLOW,EState_VSA9,SlogP_VSA2,fr_hdrzone,PEOE_VSA12,fr_piperdine,fr_Ar_N,MinPartialCharge,PEOE_VSA7,PEOE_VSA8,fr_methoxy,EState_VSA5,fr_diazo,fr_NH2,fr_guanido,fr_nitroso,fr_Ar_COO,fr_lactone,SlogP_VSA5,fr_Ar_NH,fr_priamide,SMR_VSA8,PEOE_VSA11,fr_prisulfonamd,fr_isocyan,SMR_VSA6,EState_VSA2,Chi0,fr_morpholine,fr_HOCCN,Kappa2,PEOE_VSA1,fr_imide,EState_VSA6,fr_phos_acid,VSA_EState2,BCUT2D_CHGHI,fr_alkyl_halide,MaxAbsEStateIndex,fr_sulfide,fr_urea,SlogP_VSA4,NOCount,MolLogP,VSA_EState6,EState_VSA3,fr_bicyclic,fr_azo,SlogP_VSA1,SMR_VSA1,SMR_VSA3,Chi2n,fr_dihydropyridine,Chi1v,fr_hdrzine,VSA_EState3,fr_ester,SlogP_VSA7,SlogP_VSA3,fr_Ndealkylation2,BCUT2D_LOGPHI,fr_N_O,fr_C_O,fr_sulfonamd,fr_aniline,SMR_VSA9,BertzCT,fr_thiazole,SMR_VSA4,BCUT2D_MWHI,Chi4v,fr_Imine,fr_barbitur,Chi0n,BCUT2D_MWLOW,VSA_EState7,SMR_VSA2,qed,SMR_VSA7,NumAromaticRings,MolMR,fr_phenol_noOrthoHbond,PEOE_VSA14,ExactMolWt,fr_Ndealkylation1,fr_oxazole,fr_thiophene,NumValenceElectrons,fr_ArN,NumAliphaticCarbocycles,RingCount,fr_alkyl_carbamate,Kappa1,SlogP_VSA11,fr_COO,fr_aldehyde,SMR_VSA10,FpDensityMorgan1,HeavyAtomMolWt,VSA_EState9,FpDensityMorgan3,fr_C_O_noCOO,VSA_EState10,VSA_EState1,fr_unbrch_alkane,NumHeteroatoms,TPSA,fr_amidine,BCUT2D_MRHI,PEOE_VSA6,SlogP_VSA9,VSA_EState5,NumRotatableBonds,fr_amide,Chi1n,fr_quatN,BCUT2D_CHGLO,fr_nitro_arom,fr_Al_OH_noTert,PEOE_VSA5,PEOE_VSA4,fr_lactam,)
from rdkit.Chem.rdMolDescriptors import (CalcNumAmideBonds,CalcNumLipinskiHBD,CalcNumAliphaticRings,CalcEccentricity,CalcLabuteASA,CalcNumRotatableBonds,CalcFractionCSP3,CalcChi2n,CalcChi1n,CalcNumSaturatedRings,CalcKappa2,CalcChi0v,CalcAsphericity,CalcInertialShapeFactor,CalcTPSA,CalcPMI2,CalcPBF,CalcNumHBA,CalcChi3v,CalcChi0n,CalcExactMolWt,CalcNumSaturatedHeterocycles,CalcKappa1,CalcChi4v,CalcNumAromaticCarbocycles,CalcNumLipinskiHBA,CalcPMI3,CalcSpherocityIndex,CalcPMI1,CalcNumHBD,CalcChi4n,CalcNPR1,CalcNumHeteroatoms,CalcNumAliphaticHeterocycles,CalcNumSpiroAtoms,CalcNumAliphaticCarbocycles,CalcNumAromaticHeterocycles,CalcHallKierAlpha,CalcKappa3,CalcNumRings,CalcChi3n,CalcNumSaturatedCarbocycles,CalcRadiusOfGyration,CalcNumBridgeheadAtoms,CalcNPR2,CalcChi1v,CalcNumHeterocycles,CalcNumAromaticRings,CalcChi2v,CalcPhi,)
from rdkit.Chem.GraphDescriptors import (Chi0,Chi3n,HallKierAlpha,Chi4v,Chi0n,Kappa2,Chi0v,Chi2v,Chi3v,Chi4n,Kappa1,Chi2n,Kappa3,Chi1v,Ipc,Chi1,Chi1n,BertzCT,BalabanJ,)
from rdkit.Chem.Descriptors3D import (Asphericity,Eccentricity,SpherocityIndex,PMI1,PMI3,InertialShapeFactor,NPR2,RadiusOfGyration,NPR1,PMI2,)
from rdkit.Chem.rdmolops import (GetSSSR,GetFormalCharge,)
...
class  fr_aniline_Featurizer(SingleValueMoleculeFeaturizer):
    ...
    dual_sigmoidal_norm_parameter = (0.18129261187647874, 91.42925286295274, 1.4627135733922834)  # error of 8.26E-04 with sample range (0.00E+00,1.50E+01) resulting in fit range (6.33E-08,1.00E+00)
    genlog_norm_parameter = (2.7413001530719976, -2.1327613126838796, 0.20953445963513556, 0.00014215931700537761)  # error of 1.35E-02 with sample range (0.00E+00,1.50E+01) resulting in fit range (1.41E-02,1.00E+00)
    preferred_normalization = 'dual_sig'
    # functions
...
class  fr_tetrazole_Featurizer(SingleValueMoleculeFeaturizer):
    ...
    genlog_norm_parameter = (1.107666043299223, 0.2825520504167154, 0.015205956802819295, 1.8418695786439092)  # error of 4.01E-08 with sample range (0.00E+00,2.00E+00) resulting in fit range (9.89E-01,9.99E-01)
    preferred_normalization = 'unity'
    # functions
...
class  fr_urea_Featurizer(SingleValueMoleculeFeaturizer):
    ...
    genlog_norm_parameter = (3.223218467507025, 0.46375875616833745, 0.31181586995067834, 1.8422869457271946)  # error of 1.42E-08 with sample range (0.00E+00,1.70E+01) resulting in fit range (6.23E-01,1.00E+00)
    preferred_normalization = 'min_max'
    # functions
...
class  BCUT2D_CHGHI_Featurizer(SingleValueMoleculeFeaturizer):
    ...
    dual_sigmoidal_norm_parameter = (-0.00807343779216827, 43.35367999823987, 6.98718326256343)  # error of 3.60E-02 with sample range (-1.56E+00,3.00E+00) resulting in fit range (6.81E-30,1.00E+00)
    genlog_norm_parameter = (10.493839669900748, -1.3802885737772868, 1.0884738608627027, 6.495230094877747e-07)  # error of 7.25E-02 with sample range (-1.56E+00,3.00E+00) resulting in fit range (0.00E+00,1.00E+00)
    preferred_normalization = 'dual_sig'
    # functions
...
class  GetNumAtoms_Featurizer(SingleValueMoleculeFeaturizer):
    ...
    dtype=np.int32
    # normalization
    linear_norm_parameter = (0.002806507778867817, 0.45473470197802146)  # error of 2.10E-01 with sample range (1.00E+00,8.41E+02) resulting in fit range (4.58E-01,2.82E+00)
    min_max_norm_parameter = (22.66905408053614, 70.49726350156317)  # error of 2.52E-02 with sample range (1.00E+00,8.41E+02) resulting in fit range (0.00E+00,1.00E+00)
    sigmoidal_norm_parameter = (46.36601687748812, 0.1064568334637108)  # error of 1.81E-02 with sample range (1.00E+00,8.41E+02) resulting in fit range (7.93E-03,1.00E+00)
    dual_sigmoidal_norm_parameter = (43.69601623999105, 0.15112949215358837, 0.07810101231948194)  # error of 9.64E-03 with sample range (1.00E+00,8.41E+02) resulting in fit range (1.57E-03,1.00E+00)
    genlog_norm_parameter = (0.0727753602342523, -47.88698159288098, 0.026097159197069595, 4.30932397781813e-05)  # error of 8.48E-03 with sample range (1.00E+00,8.41E+02) resulting in fit range (3.21E-08,1.00E+00)
    preferred_normalization = 'genlog'
    # functions
...
class  GetNumBonds_Featurizer(SingleValueMoleculeFeaturizer):
    ...
    dtype=np.int32
    # normalization
    linear_norm_parameter = (0.002463445651483187, 0.4744713268676017)  # error of 2.11E-01 with sample range (0.00E+00,6.70E+02) resulting in fit range (4.74E-01,2.12E+00)
    min_max_norm_parameter = (22.844223384038273, 74.02718116592182)  # error of 2.42E-02 with sample range (0.00E+00,6.70E+02) resulting in fit range (0.00E+00,1.00E+00)
    sigmoidal_norm_parameter = (48.13809784461704, 0.10066839833084439)  # error of 1.72E-02 with sample range (0.00E+00,6.70E+02) resulting in fit range (7.80E-03,1.00E+00)
    dual_sigmoidal_norm_parameter = (45.384303949473164, 0.14153158855284861, 0.07437487782630593)  # error of 9.25E-03 with sample range (0.00E+00,6.70E+02) resulting in fit range (1.62E-03,1.00E+00)
    genlog_norm_parameter = (0.0688459669579636, -51.65129697356642, 0.029975246251862264, 4.8981936120417136e-05)  # error of 8.05E-03 with sample range (0.00E+00,6.70E+02) resulting in fit range (2.60E-08,1.00E+00)
    preferred_normalization = 'genlog'
    # functions
    def featurize(self,mol):
...
class  GetNumHeavyAtoms_Featurizer(SingleValueMoleculeFeaturizer):
    ...
    dtype=np.int32
    # normalization
    linear_norm_parameter = (0.005467908306979852, 0.4574616244507832)  # error of 2.03E-01 with sample range (1.00E+00,3.53E+02) resulting in fit range (4.63E-01,2.39E+00)
    min_max_norm_parameter = (11.453920529439214, 38.17970198241566)  # error of 2.18E-02 with sample range (1.00E+00,3.53E+02) resulting in fit range (0.00E+00,1.00E+00)
    sigmoidal_norm_parameter = (24.616313202398004, 0.19249095848414596)  # error of 1.68E-02 with sample range (1.00E+00,3.53E+02) resulting in fit range (1.05E-02,1.00E+00)
    dual_sigmoidal_norm_parameter = (22.937294892052073, 0.283853605821794, 0.13930991211949958)  # error of 7.71E-03 with sample range (1.00E+00,3.53E+02) resulting in fit range (1.97E-03,1.00E+00)
    genlog_norm_parameter = (0.13246138358602916, -24.847554256961615, 0.02451623499699371, 5.5299623338359235e-05)  # error of 6.37E-03 with sample range (1.00E+00,3.53E+02) resulting in fit range (5.35E-07,1.00E+00)
    preferred_normalization = 'genlog'
    # functions
    def featurize(self,mol):
