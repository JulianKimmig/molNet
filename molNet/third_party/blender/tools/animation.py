...
def move_rotate_object(
    ...
    delta_r = rotate_object(
        obj=obj, x=x_rot, y=y_rot, z=z_rot, delta=delta_rot, animator=None
    )
    delta_m = move_object(
        obj=obj, x=x_move, y=y_move, z=z_move, delta=delta_rot, animator=None
    )
