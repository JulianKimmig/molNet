...
from rdkit.Chem.Descriptors import (MolWt,fr_sulfone,fr_Ar_N,fr_ester,VSA_EState7,fr_lactam,fr_aniline,fr_nitro_arom_nonortho,fr_Ndealkylation1,EState_VSA9,SlogP_VSA10,HeavyAtomMolWt,fr_NH2,Chi3n,Chi4v,SMR_VSA8,NumRadicalElectrons,Chi1n,Chi0,PEOE_VSA2,fr_Ndealkylation2,fr_oxazole,BalabanJ,SlogP_VSA2,EState_VSA1,MolLogP,fr_C_S,SlogP_VSA9,BCUT2D_MWHI,VSA_EState1,SMR_VSA1,Kappa1,BCUT2D_MRHI,SMR_VSA3,EState_VSA8,fr_thiophene,fr_para_hydroxylation,VSA_EState8,FpDensityMorgan2,MinPartialCharge,fr_morpholine,PEOE_VSA13,EState_VSA5,fr_lactone,PEOE_VSA5,MaxEStateIndex,fr_bicyclic,NumAromaticCarbocycles,HeavyAtomCount,fr_Ar_COO,PEOE_VSA6,BertzCT,EState_VSA10,PEOE_VSA9,SlogP_VSA12,fr_C_O_noCOO,fr_quatN,fr_COO,MaxAbsEStateIndex,VSA_EState6,SlogP_VSA7,SlogP_VSA1,SMR_VSA9,fr_term_acetylene,fr_phos_acid,PEOE_VSA4,NOCount,SlogP_VSA5,fr_alkyl_halide,NumHDonors,NumAliphaticHeterocycles,fr_tetrazole,fr_imide,EState_VSA4,Kappa2,EState_VSA7,BCUT2D_MRLOW,fr_phenol,fr_imidazole,fr_NH1,VSA_EState3,fr_nitrile,fr_SH,SlogP_VSA8,fr_phos_ester,Ipc,PEOE_VSA10,Chi1v,NumValenceElectrons,fr_furan,fr_Ar_NH,fr_ether,fr_piperzine,fr_Al_COO,SlogP_VSA6,fr_sulfide,PEOE_VSA1,fr_Ar_OH,fr_C_O,fr_barbitur,fr_isocyan,VSA_EState4,VSA_EState2,fr_nitro_arom,MinAbsEStateIndex,SMR_VSA10,qed,fr_azide,fr_epoxide,fr_urea,MaxAbsPartialCharge,MinEStateIndex,VSA_EState10,TPSA,PEOE_VSA8,VSA_EState5,SlogP_VSA3,fr_alkyl_carbamate,fr_phenol_noOrthoHbond,fr_isothiocyan,EState_VSA11,BCUT2D_CHGHI,fr_oxime,fr_ArN,fr_unbrch_alkane,SMR_VSA2,fr_Al_OH_noTert,fr_dihydropyridine,fr_guanido,fr_piperdine,fr_aldehyde,PEOE_VSA12,PEOE_VSA11,fr_Nhpyrrole,SMR_VSA4,PEOE_VSA14,fr_ketone,fr_methoxy,fr_aryl_methyl,fr_halogen,fr_hdrzine,BCUT2D_CHGLO,fr_N_O,RingCount,PEOE_VSA3,BCUT2D_MWLOW,fr_nitroso,fr_pyridine,fr_amidine,SMR_VSA7,fr_HOCCN,FpDensityMorgan3,fr_diazo,fr_Imine,EState_VSA3,fr_prisulfonamd,fr_sulfonamd,fr_nitro,NumHAcceptors,fr_COO2,fr_allylic_oxid,fr_benzodiazepine,VSA_EState9,BCUT2D_LOGPHI,EState_VSA6,MolMR,fr_thiocyan,PEOE_VSA7,fr_NH0,MaxPartialCharge,SMR_VSA6,fr_priamide,fr_thiazole,fr_Al_OH,EState_VSA2,MinAbsPartialCharge,SlogP_VSA11,fr_azo,SMR_VSA5,fr_amide,NHOHCount,FpDensityMorgan1,fr_benzene,fr_hdrzone,SlogP_VSA4,BCUT2D_LOGPLOW,fr_ketone_Topliss,)
from rdkit.Chem.rdMolDescriptors import (CalcRadiusOfGyration,CalcPMI2,CalcChi2v,CalcChi4n,CalcNumBridgeheadAtoms,CalcNumAliphaticCarbocycles,CalcPMI1,CalcNumSaturatedRings,CalcNumHBA,CalcNumSaturatedCarbocycles,CalcNumRotatableBonds,CalcNumAromaticRings,CalcNumLipinskiHBD,CalcChi0n,CalcNumUnspecifiedAtomStereoCenters,CalcLabuteASA,CalcExactMolWt,CalcNumHeteroatoms,CalcInertialShapeFactor,CalcNumHBD,CalcNPR1,CalcNumHeterocycles,CalcNumAmideBonds,CalcNumSaturatedHeterocycles,CalcNumLipinskiHBA,CalcAsphericity,CalcNumRings,CalcFractionCSP3,CalcNumAromaticHeterocycles,CalcNumAliphaticRings,CalcNumAtomStereoCenters,CalcNumSpiroAtoms,CalcPBF,CalcWHIM,GetUSRCAT,CalcMORSE,CalcRDF,CalcGETAWAY,CalcAUTOCORR3D,GetUSR,CalcCrippenDescriptors,BCUT2D,CalcAUTOCORR2D,GetHashedTopologicalTorsionFingerprintAsBitVect,GetMACCSKeysFingerprint,GetHashedAtomPairFingerprintAsBitVect,)
from rdkit.Chem.GraphDescriptors import (HallKierAlpha,Kappa3,Chi2n,Chi3v,Chi0v,Chi1,)
from rdkit.Chem.Descriptors3D import (PMI3,Eccentricity,SpherocityIndex,NPR2,)
from rdkit.Chem.rdmolops import (GetFormalCharge,GetSSSR,LayeredFingerprint,PatternFingerprint,RDKFingerprint,)
...
molecule_num_unspecified_atom_stereo_centers=NumUnspecifiedAtomStereoCentersFeaturizer()
...
molecule_get_hashed_topological_torsion_fingerprint_as_bit_vect=GetHashedTopologicalTorsionFingerprintAsBitVectFeaturizer()
...
molecule_get_hashed_atom_pair_fingerprint_as_bit_vect=GetHashedAtomPairFingerprintAsBitVectFeaturizer()
