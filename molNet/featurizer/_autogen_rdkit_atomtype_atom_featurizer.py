from molNet.featurizer._atom_featurizer import (
    SingleValueAtomFeaturizer,
    OneHotAtomFeaturizer,
)
...
def main():
    ...
    testdata = prepare_mol_for_featurization(
        Chem.MolFromSmiles("c1ccccc1").GetAtoms()[0]
    )
