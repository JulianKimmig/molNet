import numpy as np
from rdkit.Chem import (PatternFingerprint, RDKFingerprint, LayeredFingerprint)
from rdkit.Chem.AllChem import (GetHashedTopologicalTorsionFingerprint, GetHashedTopologicalTorsionFingerprintAsBitVect,
                                GetHashedAtomPairFingerprint, GetHashedAtomPairFingerprintAsBitVect,
                                GetMACCSKeysFingerprint)
from rdkit.DataStructs import (ConvertToNumpyArray)

from molNet.featurizer._molecule_featurizer import (FixedSizeMoleculeFeaturizer)
...
class Molecule_HashedTopologicalTorsionFingerprint_Featurizer(FixedSizeMoleculeFeaturizer):
...
class Molecule_HashedTopologicalTorsionFingerprintAsBitVect_Featurizer(FixedSizeMoleculeFeaturizer):
...
class Molecule_HashedAtomPairFingerprintAsBitVect_Featurizer(FixedSizeMoleculeFeaturizer):
