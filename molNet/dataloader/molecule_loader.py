...
from .base_loader import SingleFileLoader, FileDataset, ObjectDataset, GeneratorDataLoader, GeneratorDataset, \
    DirectDataLoader, DataFrameGenerator, DataFrameDataLoader
...
class SmilesfromDfLoader(SmilesLoaderMixin, DataFrameDataLoader):
    ...
    def __init__(self, df, smiles_column, additional_data=None, y_properties=None, *args, **kwargs):
...
class PytorchGeomMolGraphFromDfLoader(PytorchGeomMolLoaderMixin, MoleculeGraphFromDfLoader):
    dataloader = PytorchGeomMolGraphDataLoader

    def __repr__(self):
        return "{}_{}_{}".format(super().__repr__(), str(self.to_graph_params.get("atom_featurizer")),
